...
#'
#' The possible analysis type are: mean for [svy_mean()], median for [svy_median()], interact for [svy_interact()], prop for [svy_prop()], ratio for [svy_ratio()], or quantile [svy_quantile()].
#'
