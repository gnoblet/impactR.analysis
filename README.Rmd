...
For all analyses based on a Kobo tool, see: vignette [Survey analysis based on a Kobo tool](https://gnoblet.github.io/impactR.analysis/articles/kobo_analysis.html).
